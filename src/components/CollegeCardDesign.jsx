        ...
        <div className="card card-compact w-96 bg-slate-900 shadow-xl">
                        ...
                        <div className="card-body">
                            ...
                            <div className="card-actions justify-end">
                                <p></p>
                                <Link to={`/colleges/${college._id}`}><button class="group flex w-44 cursor-pointer select-none items-center justify-center rounded-md  px-6 py-2 text-white hover:text-success  transition">
